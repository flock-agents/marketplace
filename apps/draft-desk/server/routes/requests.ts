...
// Milo reads pending requests here and marks them fulfilled after creating new drafts.
const router = new Hono();

// GET /api/requests?status=pending — Milo reads outstanding fetch-more requests.
router.get("/", (c) => {
...
// POST /api/requests/:id/fulfilled — Milo marks a request done after creating drafts.
